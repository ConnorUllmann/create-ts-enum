...
function runTestsForValues(
  testName: string,
  a: 'a' | 0 | typeof symbolA,
  b: 'b' | 1 | typeof symbolB,
  c: 'c' | 2 | typeof symbolC,
  unrecognizedValue: string | number | typeof symbolUnrecognized
) {
  const coreMapping = {
    A: a,
    B: b,
  ...
  function CreateBasicEnum() {
    return CreateEnum({ A: coreMapping.A }, { B: coreMapping.B }, { C: coreMapping.C });
  }
